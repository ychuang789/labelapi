...
from utils.settings import PredictTarget, KeywordMatchType
from utils.data_helper import load_training_examples
from utils.tokenizers import JiebaTokenizer
...
training_set = load_training_examples(file=training_file, sample_count=500)
train_y = [d.label for d in training_set]

testing_set = load_training_examples(file=testing_file)
